...
%s = [0.3 0.2 0.31 0.41]/1000; %Espessura do Isolante m #Gilvan

d = [0.4 0.51 0.64 0.96]/1000; %Diametro do condutor m
%d = [0.4 0.5 0.64 0.96]/1000; %Diametro do condutor m #Gilvan
v = [100 100 100 100]; %
%v = [100 70 100 100]; % #Gilvan
epsonM = [2.115 2.115 2.197 2.115]; 
epsonS = [2.3 2.3 2.2 2.3]; %Permissividade eletrica relativa do revestimento dieletrico
